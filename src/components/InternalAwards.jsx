...
/**
 * Section 8 — Giải thưởng nội bộ Sata Robo Championship + thành tích bên ngoài
 * Tone: HỌC VIỆN trang trọng — giải thưởng là MINH CHỨNG cho lộ trình 5 năm
 */
export default function InternalAwards() {
  // Map level → màu nền card thành tích
  const levelStyle = {
  ...
  return (
    <section id="awards" className="section-padding bg-soft-cream">
      <div className="container-site">
        ...
        {/* ============ TOTAL PRIZE BOX ============ */}
        <div className="max-w-2xl mx-auto bg-gradient-orange-purple rounded-2xl p-6 sm:p-10 text-center text-white mb-10 shadow-xl">
          <div className="text-xs sm:text-sm font-bold uppercase tracking-wider opacity-90 mb-2">
            Tổng giá trị giải thưởng / năm
          </div>
          <div className="text-4xl sm:text-6xl font-black mb-2 drop-shadow">
            36.000.000 VNĐ
          </div>
        ...
        {/* ============ TABLE 4 PRIZE TIERS ============ */}
        <div className="max-w-4xl mx-auto card-base overflow-hidden mb-14">
          <div className="overflow-x-auto">
            <table className="w-full text-sm sm:text-base">
              <thead>
                <tr className="bg-soft-yellow border-b-2 border-primary-orange/20">
                  <th className="px-4 sm:px-6 py-4 text-left font-black uppercase text-xs sm:text-sm text-text-dark">
                    Hạng Mục
                  </th>
                  <th className="px-4 sm:px-6 py-4 text-left font-black uppercase text-xs sm:text-sm text-text-dark">
                    Giải Thưởng
        ...
        <div className="text-center mb-8">
          ...
          <h3 className="text-2xl sm:text-3xl font-black text-text-dark mb-2">
            HỌC VIÊN SATA ROBO —{' '}
          ...
          <p className="text-sm sm:text-base text-text-muted max-w-2xl mx-auto">
            Đây là 1 phần thành tích các con tại Sata Robo đã đạt được trong các kỳ thi
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 mb-10">
          {externalAchievements.map((a) => (
            <div
              key={a.level}
              className={`bg-gradient-to-br ${levelStyle[a.level]} border-2 rounded-2xl p-6 sm:p-8 text-center hover:shadow-xl hover:-translate-y-1 transition`}
            >
              <div className="text-5xl sm:text-7xl mb-3">{a.icon}</div>
              <div className="text-3xl sm:text-5xl font-black text-text-dark mb-1">
                {a.count}
              </div>
              <h4 className="font-black text-base sm:text-lg text-text-dark mb-2 uppercase tracking-wide">
                {a.title}
              </h4>
        ...
        {/* ============ CLOSING MESSAGE ============ */}
        <div className="max-w-3xl mx-auto bg-white border-l-4 border-primary-orange rounded-xl p-6 sm:p-8 shadow-md">
