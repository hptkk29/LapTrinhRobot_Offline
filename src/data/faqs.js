// =====================================
// FAQ - Cau hoi phu huynh thuong hoi
// =====================================
...
export const faqs = [
  ...
  },
  {
    ...
    answer: [
      'Mỗi buổi học kéo dài 90 phút. Lịch học cụ thể được tư vấn theo cơ sở, lớp của con và khung giờ còn chỗ.',
      {
        type: 'list',
        items: [
          'Sata1 và Sata2: 16 buổi/khóa, tổng 24 giờ.',
  ...
  },
  {
    ...
    answer: [
      'Sata Robo có 4 cơ sở tại Đà Nẵng để phụ huynh chọn nơi thuận tiện nhất.',
      {
        type: 'list',
        items: [
          'Cơ sở 1 - Hải Châu: 60 Lê Lợi, Hải Châu, Đà Nẵng.',
          'Cơ sở 2 - Hòa Cường: 258 Lê Thanh Nghị, Hòa Cường, Hải Châu.',
          'Cơ sở 3 - Thanh Khê: 269 Điện Biên Phủ, Thanh Khê, Đà Nẵng.',
          'Cơ sở 4 - Hòa Khê: 232 Nguyễn Phước Lan, Hòa Khê, Đà Nẵng.'
        ]
      },
