// =====================================
// TESTIMONIALS PHỤ HUYNH & HỌC SINH
// (lấy từ web cũ + bổ sung thêm)
// =====================================
...
export const testimonials = [
  ...
  },
  {
    ...
    content:
      'Con tưởng lập trình khó lắm, ai ngờ con làm được thật. Con thích nhất phần robot chạy sa hình — mỗi lần robot vượt qua thử thách là con thấy tự hào lắm.'
  },
  {
    id: 5,
    name: 'Anh Minh Tuấn',
    ...
    content:
      'Điều mình ấn tượng là con tập trung suốt 90 phút. Khi robot chạy được, con tự hào lắm. Mình thấy rõ giá trị của Robotics — con không còn chỉ chơi game mà bắt đầu sáng tạo.'
  },
  {
    id: 6,
    name: 'Chị Lan',
    ...
    content:
      'Con mình trước giờ chỉ thích game. Sau buổi học Trial, con nói muốn tự tạo game và robot. Mình thấy chương trình rất thực tế — không lý thuyết suông như nhiều nơi khác.'
  }
];
